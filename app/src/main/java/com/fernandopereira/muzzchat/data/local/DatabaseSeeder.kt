...
import com.fernandopereira.muzzchat.common.TWO_HOURS
import com.fernandopereira.muzzchat.common.seconds
...
class DatabaseSeeder(private val dao: MessageDao) {
    ...
    private fun buildSeedMessages(): List<MessageEntity> {
        ...
        return listOf(
            ...
            entity(
                SARAH,
                "There's a new place near the office",
                clusterA + 55.seconds,
            ), // < 20 s → grouped
            ...
            entity(
                SARAH,
                "There's a spot near the office",
                clusterB + 48.seconds,
            ), // < 20 s → grouped
